  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Enlightened Bharat Gurukul Admin Portal"
        />
      </Helmet>
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="relative mb-4">
                ...
                <img
                  ...
                  className="relative w-24 h-24 object-contain drop-shadow-[0_0_20px_rgba(250,204,21,0.4)]"
                />
              </div>
              ...
              <p className="text-yellow-400/80 text-xs tracking-[5px] uppercase mt-2">
