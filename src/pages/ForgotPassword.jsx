          ...
          <div className="relative bg-[#0a1628]/90 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 md:p-10 shadow-[0_30px_80px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="relative mb-4">
                <div className="absolute -inset-3 bg-yellow-400/15 rounded-full blur-xl"></div>

                <img
                  src={logo}
                  alt="Enlightened Bharat Logo"
                  className="relative w-24 h-24 object-contain drop-shadow-[0_0_20px_rgba(250,204,21,0.35)]"
                />
              </div>
              ...
              <p className="text-yellow-400 text-xs tracking-[5px] uppercase mt-2 text-center">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-gray-500 text-[11px] uppercase tracking-[3px] font-medium">
                Password Recovery
              </span>
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
            </div>
            ...
            {emailSent ? (
              <div className="animate-[fadeSlideIn_0.4s_ease-out]">
                ...
                <p className="text-yellow-400 text-sm font-medium text-center mb-6">
                  {email}
                </p>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    {emailError && (
                      <p className="text-red-400 text-xs mt-1.5 ml-1 animate-[fadeSlideIn_0.2s_ease-out]">
                        {emailError}
                      </p>
                    )}
                  </div>
